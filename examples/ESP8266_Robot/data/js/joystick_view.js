...
JoystickView = Backbone.View.extend({
    ...
    initialize: function(squareSize, finishedLoadCallback){
        ...
        this.array = new Float32Array(new ArrayBuffer(8)); // 8 Bytes

        this.ws.onopen = function() {
           this.ws.send("Message sent");
           alert("Message sent...");
        };
    ...
    _triggerChange: function(){
        ...
        xPercent = xPercent.toPrecision(2);
        yPercent = yPercent.toPrecision(2);
        ...
        this.array[0] = xPercent;
        this.array[1] = yPercent;
        this.ws.send(this.array);
    },
